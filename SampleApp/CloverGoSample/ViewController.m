...
- (void)calculateTotal{
    ...
    self.totalAmount = [[[self getProperAmount:self.amountTextField] decimalNumberByAdding:[self getProperAmount:self.tipTextField]] decimalNumberByAdding:[self getProperAmount:self.taxTextField]];
...
//    }
    ...
    [request setAmount:[[self getProperAmount:self.amountTextField] decimalNumberByAdding:[self getProperAmount:self.taxTextField]] setTax:[self getProperAmount:self.taxTextField] setTip:[self getProperAmount:self.tipTextField] itemName:nil setExternalPaymentId:@"abcd" lineItems:self.orderItems];
